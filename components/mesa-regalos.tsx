export const MesaRegalos = () => {
  return (
    <div id="giftTable" className="bg-[#b69f6b] flex flex-col items-center justify-center w-full">
      ...
      <div
        role="button"
        className="flex items-center justify-center cursor-pointer w-60 mb-4"
      >
        <a
        ...
        >
          <img
            ...
            alt="mesa-regalos"
          />
          <span className="flex items-center justify-center underline italic text-white cursor-pointer">51399094</span>
        </a>
      </div>
    </div>
  )
